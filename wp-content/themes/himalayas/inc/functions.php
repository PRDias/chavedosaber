...
function himalayas_footer_copyright() {
	...
	$wp_link = '<a href="" target="_blank" title="' . esc_attr__( '', 'himalayas' ) . '">' . __( '', 'himalayas' ) . '</a>';

	$tg_link =  '<a href="'.'' .'" target="_blank" title="'.esc_attr__( '', 'himalayas' ).'" rel="designer">'.__( '', 'himalayas') .'</a>';

	$default_footer_value = '<span class="copyright-text">' . sprintf( __( 'Copyright &copy; %1$s %2$s.', 'himalayas' ), date( 'Y' ), $site_link ).' '.sprintf( __( '', 'himalayas' ), '', $tg_link ).' '.sprintf( __( 'Todos os direitos reservados %s.', 'himalayas' ), $wp_link ) . '</span>';
