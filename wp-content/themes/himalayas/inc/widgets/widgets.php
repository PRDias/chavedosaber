               ...
               <div class="about-content-wrapper tg-column-wrapper clearfix">
                  ...
                  while( $the_query->have_posts() ):$the_query->the_post();
                     ...
                     <div class="about-content tg-column-2">
                        ...
                        $output .= '<div class="about-btn"> <a href="'. get_permalink() . '">' . __( 'Leia Mais', 'himalayas' ) . '</a>';
                     ...
                     <div class="blog-block">
                        ...
                        <div class="blog-content-wrapper">
                           ...
                           <div class="posted-date">
                              ...
                              <?php if( has_category() ) { ?>
                                 <span>
                                    <?php _e( 'Postado em  ', 'himalayas' );
                                    the_category(', '); ?>
                                 </span>
                              <?php } ?>
                              <span>
                                 <?php _e( 'por ', 'himalayas' ); ?>
                           ...
                           <a class="blog-readmore" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"> <?php echo __( 'Leia Mais' , 'himalayas' ) ?> <i class="fa fa-angle-double-right"> </i> </a>
                        </div>
...
class himalayas_our_team_widget extends WP_Widget {
   function __construct() {
      $widget_ops = array( 'classname' => 'widget_our_team_block', 'description' => __( '.', 'himalayas' ) );
      $control_ops = array( 'width' => 200, 'height' =>250 );
                        ...
                        <div class="tg-column-3 tg-column-bottom-margin">
                           <div class="">
                              ...
                              <div class="team-img-wrapper">
                                 ...
                                 <div class="team-img" style="bakground-color:white">
                                    <?php if( has_post_thumbnail() ) {
