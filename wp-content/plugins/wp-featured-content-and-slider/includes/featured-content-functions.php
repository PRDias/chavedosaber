...
function wpfcas_setup_post_types() {
	...
	$wpfcas_labels =  apply_filters( 'wpfcas_labels', array(
		'name'                => 'Prop. Ped.& Serviços',
		'singular_name'       => 'Prop. Ped.& Serviços',
		'add_new'             => __('Adicionar novo item', 'featured_post'),
		'add_new_item'        => __('Adicionar', 'featured_post'),
		'edit_item'           => __('Editar', 'featured_post'),
		'new_item'            => __('Novo', 'featured_post'),
		'all_items'           => __('Mostrar todos', 'featured_post'),
		'view_item'           => __('Visualizar', 'featured_post'),
		'search_items'        => __('Procurar', 'featured_post'),
		'not_found'           => __('Não encontrado', 'featured_post'),
		'not_found_in_trash'  => __('Não encontrado na lixeira', 'featured_post'),
		'parent_item_colon'   => '',
		'menu_name'           => __('Proposta Ped. & Serviços', 'featured_post'),
...
function wpfcas_add_meta_box() {
		add_meta_box('custom-metabox',__( 'Leia Mais', 'wp-featured-content-and-slider' ),'wpfcas_box_callback','featured_post');
}
