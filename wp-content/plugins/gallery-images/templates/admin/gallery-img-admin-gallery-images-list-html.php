						...
						<div id="post-body-heading">
							...
							<a href="#TB_inline?&inlineId=huge_it_gallery_add_videos&width=700&height=500"
							   class="button button-primary add-video-slide thickbox" id="slideup3s" value="iframepop">
								<span
									class="wp-media-buttons-icon"></span><?php echo __( 'Adicionar Video', 'gallery-images' ); ?>
								</span>
							</a>
						</div>
						<ul id="images-list">
									...
									case 'image': ?>
										...
										$i ++; ?>>
											...
											<div class="image-options">
												<div>
													<input class="text_area" type="text" placeholder="<?php echo __( 'Título:', 'gallery-img' ); ?>"
												...
												<div class="description-block">
													<textarea id="im_description<?php echo $rowimages->id; ?>" placeholder="<?php echo __( 'Descrição:', 'gallery-img' ); ?>"
													          name="im_description<?php echo $rowimages->id; ?>"><?php echo str_replace( '__5_5_5__', '%', $rowimages->description ) ?></textarea>
												</div>
												<div class="link-block">
													<input class="text_area url-input" type="text" placeholder="<?php echo __( 'LINK:', 'gallery-images' ); ?>"
													...
													<label class="long"
														...
														<span><?php echo __( 'Abrir em nova guia', 'gallery-images' ); ?></span>
														<input type="hidden"
												...
												<div class="like_dislike_wrapper">
													<label
														for="like_<?php echo $rowimages->id; ?>"><?php echo __( 'Classificações:', 'gallery-images' ); ?></label>
													<label for="like_<?php echo $rowimages->id; ?>"
													       class="like"><?php echo __( 'Curtida', 'gallery-images' ); ?></label>
													...
													<label for="dislike_<?php echo $rowimages->id; ?>"
													       class="dislike"><?php echo __( 'Descurtida', 'gallery-images' ); ?></label>
